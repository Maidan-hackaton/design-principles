...
так і «[Посібник з вагітності та пологів](https://www.gov.uk/maternity-benefits)» – це хороші приклади того, як ми взяли щось складне та зробили з нього щось просте та зрозуміле. [Код для Smart Answer ви можете знайти на GitHub](https://github.com/alphagov/smart-answers).


# Просувайтесь крок за кроком

Кращій спосіб створити ефективний сервіс - це почати с чогось малого та потім потім ускладнювати, але в швидкому темпі. Тому спочатку створюйте продукт [продукт з мінімальним функціоналом](http://en.wikipedia.org/wiki/Minimum_viable_product), протестуйте його на реальних людях,
просувайтесь від [альфа-](http://en.wikipedia.org/wiki/Software_release_life_cycle#Alpha) та [бета-версій](http://en.wikipedia.org/wiki/Software_release_life_cycle#Beta) до закінченого продукту додаючи нових функцій та вдосконалень, які основані на поведінці на відгуках користувачів.

Просування крок за кроком мінімізує ризики. Воно зводить нанівець вірогідність великих помилок та перетворює дрібні помилки на уроки. Це дозволяє уникнути необхідності детальних описів на 200 сторінок, які часто стають вузьким місцем. В цьому ж, знов таки, є пеервага цифрових технологій: не мости будуємо - все можна виправити.

## Кілька прикладів як ми просувались
