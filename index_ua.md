...
Нижче наведені загальни принципи проектування та приклади їх практичного використання.
...
Процесс проектування має починатися с виявлення та анізу потреб простого користувача.Ми маємо буду зорієнтовані саме на це, а не на існуючий "офіційний процесс". Наше розуміння потреб має базуватися на фактах, а не на припущеннях чи побажаннях: слід усвідомлювати, що те, про що присть користувач не завжди є тим, що йому насправді потрібно.

Саме потреби ми використовуєм потреби як організаційні принципи, тому що користувачі заходять на наші сайти заради
