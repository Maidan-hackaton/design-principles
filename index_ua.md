...
3. [Проектуйте, використовуючи інформацію](#_design_with_data)
...
# Проектуйте, використовуючи інформацію
...
## Приклада того, як ми проектуємо, використовуючи інформацію
...
є добрим прикладом. Як «[Скидка с подоходного налога для семейных пар](https://www.gov.uk/calculate-married-couples-allowance)»,
